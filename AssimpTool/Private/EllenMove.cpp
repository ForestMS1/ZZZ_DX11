...
EllenMove::EllenMove(shared_ptr<GameObject> gameObject, shared_ptr<StateMachine> stateMachine)
...
void EllenMove::Awake()
{
}

void EllenMove::Start()
{
}

void EllenMove::Update()
{
	Input();
}

void EllenMove::LateUpdate()
{

}

void EllenMove::FixedUpdate()
{
}

HRESULT EllenMove::Render()
{
	return S_OK;
}

void EllenMove::OnCollisionEnter(const Collision& collision)
{
}

void EllenMove::OnCollisionExit(const Collision& collision)
{
}

void EllenMove::OnExit()
{
	auto stateMachine = static_pointer_cast<EllenStateMachineScript>(_stateMachine.lock());
	stateMachine->_moveSpeed = 0.f;
}
